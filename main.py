...
def get_facebook_data(event, context):
    ...
    # if not 'start_date' in event['attributes']:
    #
    ...
    #
    #     date_range = [yesterday - i for i in range((yesterday - start_date).days)]
    #     for dday in date_range:
    #         cur_source = []
    #         params = {'access_key': api_key,
    #                   'currencies': to_currency,
    #                   'source': from_currency,
    #                   'date': dday.strftime("%Y-%m-%d")
    #                   }
    #
    #
    #         try:
    ...
    #
    #             cur_source.append({'date': dday.strftime("%Y-%m-%d"),
    #                                'currencies': source,
